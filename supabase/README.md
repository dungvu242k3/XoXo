# Hướng dẫn Migration từ Firebase sang Supabase
...
## Bước 5: Migration Data (Tùy chọn)

Nếu bạn có dữ liệu từ Firebase, cần migrate:

1. Export data từ Firebase
2. Chuyển đổi format JSON sang format PostgreSQL
3. Import vào Supabase bằng SQL hoặc Dashboard
